...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p b074868b-307b-4510-97c6-57ff142da52b
```

> `b074868b-307b-4510-97c6-57ff142da52b` is the password of the certificate, you can change it to any password you want.
